...
export default function ReviewsPage() {
  return (
    <section className="hero-desert">
      <Container>
        <h1 className="text-4xl font-bold text-[color:var(--text)] mb-4">Product Reviews</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card
            ...
            href="/blog"
          >
            <div className="text-oasis font-semibold">View All →</div>
          </Card>
        </div>

        <section className="mt-16">
          <h2 className="text-3xl font-bold text-[color:var(--text)] mb-6">Review Categories</h2>
          <div className="space-y-4">
            <div className="card p-6">
              <h3 className="text-xl font-bold text-[color:var(--text)] mb-2">Cat Litter</h3>
            ...
            <div className="card p-6">
              <h3 className="text-xl font-bold text-[color:var(--text)] mb-2">Self-Cleaning Boxes</h3>
              <p className="text-[color:var(--subtext)] mb-4">
                Automatic litter boxes from Litter-Robot, PETKIT, CATLINK, and more.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-xl font-bold text-[color:var(--text)] mb-2">Accessories</h3>
              <p className="text-[color:var(--subtext)] mb-4">
