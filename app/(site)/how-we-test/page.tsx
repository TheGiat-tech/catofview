  ...
  return (
    <section className="hero-desert">
      <Container className="max-w-4xl">
        <h1 className="text-4xl font-bold text-[color:var(--text)] mb-6">How We Test</h1>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[color:var(--text)] mb-6">Testing Criteria</h2>
          <div className="space-y-4">
            <div className="card border-l-4 border-camel p-6">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold text-[color:var(--text)]">Odor Control</h3>
                <span className="text-2xl font-bold text-camel">35%</span>
              </div>
            ...
            <div className="card border-l-4 border-camel p-6">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold text-[color:var(--text)]">Safety</h3>
                <span className="text-2xl font-bold text-camel">25%</span>
              </div>
              <p className="text-[color:var(--subtext)]">
            ...
            <div className="card border-l-4 border-camel p-6">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold text-[color:var(--text)]">Maintenance & Ease of Use</h3>
                <span className="text-2xl font-bold text-camel">20%</span>
              </div>
              <p className="text-[color:var(--subtext)]">
            ...
            <div className="card border-l-4 border-camel p-6">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold text-[color:var(--text)]">App Features (if applicable)</h3>
                <span className="text-2xl font-bold text-camel">10%</span>
              </div>
              <p className="text-[color:var(--subtext)]">
            ...
            <div className="card border-l-4 border-camel p-6">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold text-[color:var(--text)]">Noise Level</h3>
                <span className="text-2xl font-bold text-camel">10%</span>
              </div>
              <p className="text-[color:var(--subtext)]">
        ...
        {/* Testing Protocol */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[color:var(--text)] mb-6">Our Testing Protocol</h2>
          <div className="bg-[color:var(--bg-muted)] rounded-card p-8 border border-[color:var(--border)]">
            <ol className="space-y-6">
              <li className="flex">
                <span className="flex-shrink-0 w-8 h-8 bg-camel text-night rounded-full flex items-center justify-center font-bold mr-4">
                  1
                </span>
                <div>
                  <h3 className="font-bold text-[color:var(--text)] mb-2">Initial Setup</h3>
                  <p className="text-[color:var(--subtext)]">
              ...
              <li className="flex">
                ...
                <div>
                  <h3 className="font-bold text-[color:var(--text)] mb-2">Real-World Testing (2+ weeks)</h3>
                  <p className="text-[color:var(--subtext)]">
              ...
              <li className="flex">
                ...
                <div>
                  <h3 className="font-bold text-[color:var(--text)] mb-2">Standardized Testing</h3>
                  <p className="text-[color:var(--subtext)]">
              ...
              <li className="flex">
                ...
                <div>
                  <h3 className="font-bold text-[color:var(--text)] mb-2">Long-Term Evaluation</h3>
                  <p className="text-[color:var(--subtext)]">
              ...
              <li className="flex">
                ...
                <div>
                  <h3 className="font-bold text-[color:var(--text)] mb-2">Scoring & Review</h3>
                  <p className="text-[color:var(--subtext)]">
        ...
        {/* Independence */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[color:var(--text)] mb-6">Our Commitment</h2>
          <div className="bg-desert-100 border border-[color:var(--border)] rounded-card p-8">
            <h3 className="text-xl font-bold text-[color:var(--text)] mb-4">Editorial Independence</h3>
            <p className="text-[color:var(--subtext)] mb-4">
            ...
            <h3 className="text-xl font-bold text-[color:var(--text)] mb-4">Transparency</h3>
            <p className="text-[color:var(--subtext)] mb-4">
            ...
            <h3 className="text-xl font-bold text-[color:var(--text)] mb-4">Updates</h3>
            <p className="text-[color:var(--subtext)]">
        ...
        {/* Limitations */}
        <section>
          <h2 className="text-3xl font-bold text-[color:var(--text)] mb-6">Testing Limitations</h2>
          <div className="prose">
            <p>
